...
;(defthm logxor-of-n32p
;  (implies (and (n32p x) (n32p y))
;	   (n32p (logxor x y))))
;
;(defthm n32p-of-rgfi
;  (implies (and (n05p i) (rv32p rv32)) (n32p (rgfi i rv32)))
;  :hints (("Goal" :in-theory (enable rgfi rv32p rgfp))))
...
;;
;; TODO: This needs to be sign extended
...
(define asm-add ((rs1 n05p) (rs2 n05p) (rd n05p))
 (mbe
				    ;;  funct7
  :logic (+ (ash *add-funct7* 25) ;;  [------- | rs2 | rs1 | funct3 | rd | OP ]
            (ash (n05 rs2)    20)
            (ash (n05 rs1)    15)
            (ash *add-funct3* 12)
            (ash (n05 rd)      7)
...
(gl::def-gl-thm get-opcode-of-asm-add-gl
  :hyp (and (n05p i) (n05p j) (n05p k))
  :concl (equal (get-opcode (logand (+ 51 (ash k 7) (ash i 15) (ash j 20)) 127)) #0b0110011)
...
(defthm get-opcode-of-asm-add 
  (equal (get-opcode (asm-add i j k)) #0b0110011)
  :hints (("Goal" :in-theory (enable asm-add)
...
(defthm get-rd-of-asm-add
  (equal (get-rd (asm-add rs1 rs2 rd)) (n05 rd))
  :hints (("Goal" :in-theory (enable asm-add))))
...
(gl::def-gl-thm get-opcode-of-asm-sub-gl
  :hyp (and (n05p i) (n05p j) (n05p k))
  :concl (equal (get-opcode (logand (+ 1073741875 (ash k 7) (ash i 15) (ash j 20)) 127)) #0b0110011)
  :g-bindings (gl::auto-bindings (:nat i 5) (:nat j 5) (:nat k 5)))
...
(defthm get-opcode-of-asm-sub 
  (equal (get-opcode (asm-sub i j k)) #0b0110011)
  :hints (("Goal" :in-theory (enable asm-sub)
...
(gl::def-gl-thm get-opcode-of-asm-xor-gl
  :hyp (and (n05p i) (n05p j) (n05p k))
  :concl (equal (get-opcode (logand (+ 16435 (ash k 7) (ash i 15) (ash j 20)) 127)) #0b0110011)
  :g-bindings (gl::auto-bindings (:nat i 5) (:nat j 5) (:nat k 5)))
...
(defthm get-opcode-of-asm-xor
  (equal (get-opcode (asm-xor i j k)) #0b0110011)
  :hints (("Goal" :in-theory (enable asm-xor)
...
(gl::def-gl-thm get-opcode-of-asm-or-gl
  :hyp (and (n05p i) (n05p j) (n05p k))
  :concl (equal (get-opcode (logand (+ 24627 (ash k 7) (ash i 15) (ash j 20)) 127)) #0b0110011)
  :g-bindings (gl::auto-bindings (:nat i 5) (:nat j 5) (:nat k 5)))
...
(defthm get-opcode-of-asm-or
  (equal (get-opcode (asm-or i j k)) #0b0110011)
  :hints (("Goal" :in-theory (enable asm-or)
...
(gl::def-gl-thm get-opcode-of-asm-and-gl
  :hyp (and (n05p i) (n05p j) (n05p k))
  :concl (equal (get-opcode (logand (+ 28723 (ash k 7) (ash i 15) (ash j 20)) 127)) #0b0110011)
  :g-bindings (gl::auto-bindings (:nat i 5) (:nat j 5) (:nat k 5)))
...
(defthm get-opcode-of-asm-and
  (equal (get-opcode (asm-and i j k)) #0b0110011)
  :hints (("Goal" :in-theory (enable asm-and)
...
(gl::def-gl-thm get-opcode-of-asm-sll-gl
  :hyp (and (n05p i) (n05p j) (n05p k))
  :concl (equal (get-opcode (logand (+ 4147 (ash k 7) (ash i 15) (ash j 20)) 127)) #0b0110011)
  :g-bindings (gl::auto-bindings (:nat i 5) (:nat j 5) (:nat k 5)))
...
(defthm get-opcode-of-asm-sll
  (equal (get-opcode (asm-sll i j k)) #0b0110011)
  :hints (("Goal" :in-theory (enable asm-sll)
...
(gl::def-gl-thm get-opcode-of-asm-srl-gl
  :hyp (and (n05p i) (n05p j) (n05p k))
  :concl (equal (get-opcode (logand (+ 20531 (ash k 7) (ash i 15) (ash j 20)) 127)) #0b0110011)
  :g-bindings (gl::auto-bindings (:nat i 5) (:nat j 5) (:nat k 5)))
...
(defthm get-opcode-of-asm-srl
  (equal (get-opcode (asm-srl i j k)) #0b0110011)
  :hints (("Goal" :in-theory (enable asm-srl)
...
;; Shift Right Arithmatic THEOREMS
...
(gl::def-gl-thm get-opcode-of-asm-sra-gl
  :hyp (and (n05p i) (n05p j) (n05p k))
  :concl (equal (get-opcode (logand (+ 1073762355 (ash k 7) (ash i 15) (ash j 20)) 127)) #0b0110011)
  :g-bindings (gl::auto-bindings (:nat i 5) (:nat j 5) (:nat k 5)))
...
(defthm get-opcode-of-asm-sra
  (equal (get-opcode (asm-sra i j k)) #0b0110011)
  :hints (("Goal" :in-theory (enable asm-sra)
...
(gl::def-gl-thm get-opcode-of-asm-slt-gl
  :hyp (and (n05p i) (n05p j) (n05p k))
  :concl (equal (get-opcode (logand (+ 8243 (ash k 7) (ash i 15) (ash j 20)) 127)) #0b0110011)
  :g-bindings (gl::auto-bindings (:nat i 5) (:nat j 5) (:nat k 5)))
...
(defthm get-opcode-of-asm-slt
  (equal (get-opcode (asm-slt i j k)) #0b0110011)
  :hints (("Goal" :in-theory (enable asm-slt)
...
(gl::def-gl-thm get-opcode-of-asm-sltu-gl
  :hyp (and (n05p i) (n05p j) (n05p k))
  :concl (equal (get-opcode (logand (+ 12339 (ash k 7) (ash i 15) (ash j 20)) 127)) #0b0110011)
  :g-bindings (gl::auto-bindings (:nat i 5) (:nat j 5) (:nat k 5)))
...
(defthm get-opcode-of-asm-sltu
  (equal (get-opcode (asm-sltu i j k)) #0b0110011)
  :hints (("Goal" :in-theory (enable asm-sltu)
