...
;(gl::def-gl-thm get-funct7-of-asm-sb-gl
;  :hyp (and (n05p i) (n05p k) (n05p j) (n07p l))
;  :concl (equal (get-funct7 (+ (ash           l   25)
;                               (ash           j   20)
;                               (ash           i   15)
;                               (ash *sb-funct3*   12)
;                               (ash           k   7)
...
;
;(defthmd get-funct7-of-asm-sb 
;  (equal (get-funct7 (asm-sb rs1 rs2 imm)) (n07 (ash (n12 imm) -5)))
;  :hints (("Goal" :in-theory (enable asm-sb)
;                  :use ((:instance get-funct7-of-asm-sb-gl  (i (n05 rs1)) (k (n05 (n12 imm))) (l (n07 (ash (n12 imm) -5))) (j (n05 rs2)))))))
;
...
;(gl::def-gl-thm n01-of-n13
;  :hyp (n13p x)
;  :concl (equal (n01 (n13 x)) (n01 x))
;  :g-bindings (gl::auto-bindings (:nat x 13)))
;
;(defthm n01-of-n13
;  (implies (n13p x)
;  	   (equal (n01 (n13 x)) (n01 x))))
;
;(encapsulate
; nil
...
;  (equal (n01 (n13 x)) (n01 x)))
;)
;(defthm n01-neq-lemma
;  (implies (equal (n01 (n13 x)) 0)
;	   (not (equal (n01 x) 1)))
...
(defthm get-b-imm-of-asm-beq
  ...
  :hints (("Goal" :in-theory (enable asm-beq)
         ...
         ; ("Subgoal 4" :use ((:instance n01-of-n13 (x (n13 imm)))))))

; get-rs2-of-asm-beq-gl (i     (n05 rs2)) 
;						            (j     (n05 rs2))
;						            (k12   (n01 (ash imm -12)))
;						            (k11   (n01 (ash imm -11)))
;						            (k10-5 (n06 (ash imm -5 )))
